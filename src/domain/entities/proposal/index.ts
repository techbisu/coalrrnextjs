...
export type { IProposalRepository, ProposalDTO, PlotScheduleDTO, PlotScheduleLandTypeDTO, MouzaAbstractRowDTO, MouzaAbstractResultDTO, ProposalCostSheetData } from './IProposalRepository'
