...
export function DocToc({ headings }: DocTocProps) {
  ...
  return (
    <div className="w-64 shrink-0 hidden lg:block px-4 py-4 space-y-3 border-l border-slate-200 dark:border-slate-800 text-xs sticky top-14 h-[calc(100vh-3.5rem)]">
