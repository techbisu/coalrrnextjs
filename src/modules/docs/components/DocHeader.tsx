...
export function DocHeader({ meta, onToggleSidebar, onOpenSearch }: DocHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between h-14 px-4 sm:px-6 bg-white/90 dark:bg-slate-900/90 backdrop-blur border-b border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200">
      ...
      <div className="flex items-center gap-3 truncate min-w-0">
        ...
        <Link
          href="/docs"
          className="text-xs font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 flex items-center gap-1 shrink-0"
        >
      ...
      <div className="flex items-center gap-2 shrink-0">
        {onOpenSearch && (
          <Button
            ...
            className="h-8 text-xs gap-2 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800"
          >
        ...
        {meta && (
          <>
            <Badge variant="secondary" className="hidden md:flex items-center gap-1 text-[11px] font-normal py-0.5 px-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300">
