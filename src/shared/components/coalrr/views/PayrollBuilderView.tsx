...
import { SectionCard, MathPreviewPanel, DataTable, ApprovalPanel, StatusTimeline, StateBadge, SmartChecklist } from '@/shared/components/coalrr'
import type { Column, MathPreviewResultLike, AvailableTransition, ReviewTaskView, TimelineNode, ChecklistItem } from '@/shared/components/coalrr'
