...
export function StatusTimeline({ nodes, className, maxheight = 380 }: StatusTimelineProps) {
  return (
    <div 
      className={cn('overflow-y-auto overflow-x-hidden pr-3 max-h-[380px] space-y-1', className)} 
