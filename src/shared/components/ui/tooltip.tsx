  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          "bg-slate-900 text-slate-50 border border-slate-800 shadow-xl animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-fit rounded-lg px-3 py-2 text-xs font-medium dark:bg-slate-950 dark:border-slate-800",
          className
        )}
        {...props}
      >
        {children}
        {showArrow && <TooltipPrimitive.Arrow className="fill-slate-900 dark:fill-slate-950 z-50" />}
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
